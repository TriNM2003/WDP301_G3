...
import { Card, Avatar, Button, List, Typography, Layout, Tooltip, Row, Col, Calendar, Alert, DatePicker } from "antd";
import { ftOutlined, PlusCircleFilled, LeftOutlined, RightOutlined } from "@ant-design/icons";
...
const ProjectList = () => {
    ...
    const { projects, user, userActivities, site } = useContext(AppContext);
    ...
    const filterActivitiesByWeek = (weekStart, weekEnd) => {
        return userActivities.filter((activity) => {
            ...
            return (
                ...
                activity.assignee?.some(assignee => assignee._id === user._id)
            );
        });
            ...
            <Content style={{ padding: "10px 10px", textAlign: "left" }}>
                <Row gutter={[16, 16]}>
                                        ...
                                        <List.Item>
                                            ...
                                            >
                                                ...
                                                <Text type="secondary" style={{ fontSize: "12px" }}>
                                                    Last update: {getRelativeTime(project?.updatedAt)}
                                                </Text>
                                            </Card>
                                        </List.Item>
                                    )}
                    ...
                    <Col xs={24} md={9}>
                        <div style={{ flex: 1 }}>
                            <Card
                                title={<div style={{ textAlign: "center", width: "100%" }}>Schedule</div>}
