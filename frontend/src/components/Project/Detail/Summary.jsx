  ...
  return (
    <div style={{ padding: "2% 5%" }}>
      ...
      <Row style={{ padding: "2% 0" }} justify="space-between">
        <Col span={5}>
          <Card style={{ boxShadow: "0 4px 8px rgba(0, 0, 0, 0.1)", textAlign: "start" }}>
            ...
            />
            <p style={{ margin: 0 }}>in the last week</p>
          </Card>
        </Col>
        ...
        <Col span={5}>
          <Card style={{ boxShadow: "0 4px 8px rgba(0, 0, 0, 0.1)", textAlign: "start" }} >
            ...
            />
            <p style={{ margin: 0 }}>in the next week</p>
          </Card>
        </Col>
      </Row>
      <Row style={{ padding: "2% 0" }} justify="space-between">
        <Col span={11}>
          <Card style={{ boxShadow: "0 4px 8px rgba(0, 0, 0, 0.1)", overflow: "auto", height: "400px", textAlign: "start" }} >
            ...
            <Title level={4} style={{ margin: 0 }} >Activity Summary</Title>
        ...
        <Col span={11} >
          <Card style={{ boxShadow: "0 4px 8px rgba(0, 0, 0, 0.1)", overflow: "auto", height: "400px", paddingBottom: "5%", textAlign: "start" }}  >
            <Title level={4} style={{ margin: 0 }} >Project Capacity Overview</Title>
            ...
            <Flex style={{ margin: "2% 0" }} justify='space-between' align='start'>
              <Col span={4}>
                <small style={{ fontWeight: "bolder", color: grey[4] }}>Member</small>
              </Col>
              <Col span={18} align="start">
                <small style={{ fontWeight: "bolder", color: grey[4] }}>Work distribution</small>
      ...
      <Row style={{ padding: "2% 0" }} justify="space-between">
        <Col span={11}>
          <Card style={{ boxShadow: "0 4px 8px rgba(0, 0, 0, 0.1)", overflow: "auto", height: "400px", paddingBottom: "5%", textAlign: "start" }}   >
            <Title level={4} style={{ margin: 0 }} >Task Prioritization Overview</Title>
        ...
        <Col span={11}>
          <Card style={{ boxShadow: "0 4px 8px rgba(0, 0, 0, 0.1)", overflow: "auto", height: "400px", paddingBottom: "5%", textAlign: "start" }}   >
            <Title level={4} style={{ margin: 0 }} >Types of work</Title>
